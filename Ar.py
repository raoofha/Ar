...
test = lambda a,b: [(print(f'\x1b[31m{a}\x1b[0m', "==" ,x, f'\x1b[31m{b}\x1b[0m') if str(x)!=str(b) else print(f'\x1b[32m{a}\x1b[0m', "==",x)) if b!=None else print(a,"==",x) for x in [eval(a)]]
...
print(div(4,1))
print(div(4,0))
print(format(int(div(4,1)),'b'))
print(format(int(div(4,0)),'b'))
